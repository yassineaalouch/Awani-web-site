      ...
      <div className="flex flex-col">
          ...
          <form onSubmit={editingEmail ? editAdmin : addAdmin}>
            ...
            <dev className="flex gap-2">
                <button type="submit" className="btn btn-primary py-1">{editingEmail ? "Update" : "Save"}</button>
          ...
          <table  className="basic ">
            <thead>
              <tr>
                ...
                <td className="text-center" title="Get notified when an order is received."><b>Notification</b></td>
              </tr>
            </thead>
            <tbody>
                ...
                <tr key={admin.email}>
                  ...
                  <td className=" ">
                    <div className="relative bg-slate-300">
                        <input className="absolute top-[50%] left-[50%] centreAbsolute z-50 opacity-0" checked={admin.getOrderEmail}  onChange={(e) => NotificationHandler(admin._id, e.target.checked)}  type="checkbox"/>
                        <div className="absolute top-[50%] left-[50%] centreAbsolute">
                          {admin.getOrderEmail?<MdOutlineNotificationsOff/>:<MdOutlineNotificationsNone/>}
                        </div>
                    </div>
                  </td>
                </tr>
