...
import Formulair from "@/components/interfaceComponents/Formulair";
  ...
  return (
    <div className="">
      ...
      <div className=" flex flex-col justify-center mt-10 items-center text-2xl">
        ...
        <p className="px-2 text-sm md:text-lg text-center">
          زبوننا العزيز، إذا كان لديك أي تساؤلات، استفسارات أو شكاوى، لا تتردد في التواصل معنا. يمكنك مراسلتنا عبر البريد الإلكتروني أو عبر تطبيق واتساب أو استخدام النموذج أدناه. نشكرك جزيلاً على ثقتك بخدماتنا ونتطلع لخدمتك بأفضل ما لدينا.
        </p>
      </div>
      <div className="min-h-screen my-9 flex justify-center items-center ">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mx-5 md:mx-0 h-fit">
          <div className="w-fit">
            <ContactCard />
          </div>
          <div className="flex justify-center w-full">
            <Formulair blacklist={blacklist} className="!w-full !h-full" />
          </div>
        </div>
      </div>
      <div>
      ...
      {/* <div className="grid grid-cols-1 md:grid-cols-2 text-center gap-5 px-10 my-10">
        <div>
