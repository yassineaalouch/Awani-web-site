  ...
  return (
    <Layout>
      <div className="max-w-4xl mx-auto px-4 py-8">
        <h1 className="this text-3xl font-bold mb-8">Black List Page</h1>
        <div className="bg-white shadow-md rounded-lg p-6 mb-8">
          <form onSubmit={editingEmail ? editAdmin : addAdmin} className="space-y-4">
            <label className="this block text-lg font-medium">
              {editingEmail ? "Edit email" : "Add an email"}
            </label>
            <input
              value={email}
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
          <table className="basic w-full">
            <thead className="bg-gray-100">
              <tr>
                <td className="py-3 px-4 font-bold text-lg">Blocked emails</td>
