...
export default function SideBarUserAccount({session}) {
        ...
        <ul className="mt-4 grid grid-cols-5 md:block" >
          ...
          <li className='border-b border-gray-300'>
            <Link
              href={'/user/account'}
              className={`block w-full text-left px-4 py-2 ${
                activeTab === 'account' ? 'bg-yellow-500 text-white' : 'hover:bg-gray-200'
              }`}
          ...
          <li className='border-b border-gray-300'>
            <Link
              href={'/user/page3'}
              className={`block w-full text-left px-4 py-2 ${
                activeTab === 'addresses' ? 'bg-yellow-500 text-white' : 'hover:bg-gray-200'
              }`}
          ...
          <li className='border-b border-gray-300'>
            <Link
              href={'/user/page4'}
              className={`block w-full text-left px-4 py-2 ${
                activeTab === 'wishlist' ? 'bg-yellow-500 text-white' : 'hover:bg-gray-200'
              }`}
          ...
          <li className='border-b border-gray-300'>
            <Link
              ...
              className={`flex items-center gap-3 w-full text-left px-4 py-2 ${
                activeTab === 'logout' ? 'bg-yellow-500 text-white' : 'hover:bg-gray-200'
              }`}
          ...
          <li className='border-b border-gray-300'>
            ...
            href={'/user/delete'}
            className={`flex items-center gap-3 w-full text-left px-4 py-2 ${
                activeTab === 'Delete' ? 'bg-yellow-500 text-white' : 'hover:bg-gray-200'
            }`}
