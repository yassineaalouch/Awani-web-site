...
//       {!pathname.includes('/products')&&<h1 className='text-xl font-semibold text-gray-800 mb-4'>User Ratings</h1>}
...
//               <div
//                 className={Math.round((ratingDistribution[rating] / totalRatings) * 100)?'bg-yellow-500 h-2 rounded-full':'bg-gray-200 h-2 rounded-full'}
...
//               </div>
//               <div>
//                { (Math.round((ratingDistribution[rating] / totalRatings) * 100)? Math.round((ratingDistribution[rating] / totalRatings) * 100):'0')}%
//               </div>
//             </span>
//           </div>
//         ))}
...
//           <div key={rating} className='flex max-w-[95%] items-center'>
//             <span className='text-yellow-500 flex'>
//               {/* Render empty stars first, then full stars to achieve right-to-left fill */}
//               {[...Array(5 - Number(rating))].map((_, i) => (
//                 <svg key={i} className='h-5 inline text-gray-300' fill="currentColor" viewBox="0 0 24 24">
//                   <path d="M12 .587l3.668 7.455L24 9.588l-6 5.857L19.336 24 12 19.765 4.664 24 6 15.445 0 9.588l8.332-1.546z" />
//                 </svg>
